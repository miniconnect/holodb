...
class TransformingSortedSourceTest {
    ...
    @Test
    void testBasics() {
        TransformingSortedSource<BigInteger, String> source = createTransformingIndexedSource();
    ...
    private static TransformingSortedSource<BigInteger, String> createTransformingIndexedSource() {

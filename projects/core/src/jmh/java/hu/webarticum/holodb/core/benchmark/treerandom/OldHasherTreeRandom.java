...
public class OldHasherTreeRandom implements TreeRandom {
    ...
    public OldHasherTreeRandom(long seed) {
        this(LargeInteger.of(seed));
    }

    public OldHasherTreeRandom(LargeInteger seed) {
        this(seed.toByteArray());
    }

    public OldHasherTreeRandom(String seed) {
        this(seed.getBytes());
    }
    ...
    public OldHasherTreeRandom(long seed, Hasher hasher) {
        this(LargeInteger.of(seed), hasher);
    }

    public OldHasherTreeRandom(LargeInteger seed, Hasher hasher) {
    ...
    public OldHasherTreeRandom(long seed, Hasher hasher, BiFunction<byte[], byte[], ByteSource> additionalByteSourceFactory) {
        this(LargeInteger.of(seed), hasher, additionalByteSourceFactory);
    }

    public OldHasherTreeRandom(LargeInteger seed, Hasher hasher, BiFunction<byte[], byte[], ByteSource> additionalByteSourceFactory) {
    ...
    public TreeRandom sub(byte[] key) {
        ...
        return new OldHasherTreeRandom(bytesForSub, hasher, additionalByteSourceFactory, false);
    }
